...
Omega = np.array([44.77329198,56.01651091,70.20318779,105.3047817,129.3279995,162.4961717,203.1202147])/1000
m = np.array([74.2, 92.4, 115.8,  173.8, 213.3, 269.1, 335.5])
M = (m*9.81)*121/1000000
print(M)
koef1, koef2 = mnk(M, Omega)
printk=int(koef1*1000)/1000
printb=int(koef2*1e5)/1e5
plt.plot(M, M*koef1 + koef2, color = 'r', label = f'k={printk}, b={printb}')
